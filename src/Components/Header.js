...
function Header() {
  ...
  return (
    <header className={`header ${isVisible ? 'visible' : 'hidden'}`}>
      ...
      <div className="logo">
      <Link to="/">
        <img src="http://localhost:3000/images/psyche-logo.png" alt="PSCYCHE LOGO"></img>
        </Link>
      ...
      <Link to="/info">Info</Link>
          ...
          <img src="http://localhost:3000/images/instagram-logo.png" alt="INSTAGRAM" class="instagram-icon" href="/"></img>
        </a>
      </nav>
